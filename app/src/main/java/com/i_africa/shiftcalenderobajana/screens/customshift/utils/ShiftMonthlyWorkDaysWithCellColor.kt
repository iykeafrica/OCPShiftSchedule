...
private val TAG = ShiftMonthlyWorkDaysWithCellColor::class.simpleName

object ShiftMonthlyWorkDaysWithCellColor {

    fun updateCellBackground(
    ...
    private fun setBackgroundColor(
        ...
        val dateDifference = setFormula(day, month, year)
        val shiftDuty = computeShiftDuty(dateDifference, collection)
