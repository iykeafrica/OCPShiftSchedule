...
private val TAG = ShiftMonthlyWorkDaysWithCellColor2::class.simpleName

object ShiftMonthlyWorkDaysWithCellColor2 {

    fun updateCellBackground2(
    ...
    private fun setBackgroundColor(
        ...
        val dateDifference = setFormula2(day, month, year)
        val shiftDuty = computeShiftDuty2(dateDifference, collection)
